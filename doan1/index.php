...
<body>
    ...
    <div class="slideshow-container">
        <div class="mySlides fade">
            <img src="Image/slideshow1.png" style="width: 100%; height: 40em;" alt="">       <!--40em: chiều cao của hình ảnh gấp 40 lần kích thước cỡ chữ  -->
        </div>
    ...
    <div class="download-buttons">
        <div class="button-container">
            <a href="https://play.google.com/store/apps/details?id=com.garena.game.kgvn&referrer=af_tranid%3DqDuJJB-_cC36rCmENtMBfA%26c%3Dobt_lp_and%26pid%3DOrganicA"
                ...
                <img src="Image/ggplay.png" style="height: 5em; margin-bottom: -3.1em"> <!--margin-bottom: tạo khoảng trống bên dưới phần tử; margin-bottom: có giá trị âm thì phần tử sẽ dịch chuyển lên trên và "ăn" vào khoảng trống của phần tử bên trên nó; margin-right: Tạo khoảng trống bên phải phần tử-->
            </a>
            <a href="https://apps.apple.com/vn/app/garena-li%C3%AAn-qu%C3%A2n-mobile/id1150288115?mt=8"
                class="download-button">
                <img src="Image/Appstore.png" style="height: 7.5em;margin-bottom: -4.3em ;margin-right: 1em;"></a>
        </div>
    </div>
    <div class="container">
        <div>
        ...
        <div id="tin-tuc-nho" class="rectangle-container">
            <div class="rectangle">
                ...
                <p style="color: rgb(169, 169, 39);">GIẢI ĐẤU LIÊN QUÂN MOBILE QUỐC TẾ</p>       <!-- rgb(169, 169, 39): màu chữ là một màu vàng nhạt hơi xanh xanh.-->
            </div>
            <div class="rectangle">
            ...
            <div style="margin-top: 18em;">
                <a href="Tintuc.php" style="color: rgb(169, 169, 39);text-decoration: none;font-size: 2em;">Xem
                    thêm>></a>  <!--text-decoration: Thuộc tính này được sử dụng để loại bỏ các trang văn bản như gạch dưới, ngang hoặc gạch ngang trên; font-size: 2em : cỡ chữ gấp 2 lần cỡ chữ ban đầu-->
            </div>
        </div>
        ...
        <hr style="background-color: rgb(169, 169, 39);height: 5px;border: none;">  <!--border: none: Thuộc tính này xác định rõ rằng phần tử không có bất kỳ đường viền nào. Điều này loại bỏ tất cả các đường viền mà phần tử có thể có, bất kể kiểu đường viền hoặc màu sắc của nó.-->
        <div>
            <div>
                <div class="blockdown">
                    <img style="text-align: center;margin-top: 3em;" src="Image/requiredevice.png" alt="">  <!--text-align: center: Căn giữa văn bản trong phần tử theo chiều ngang.-->
